...
# The histogram shows the consumption of electric active power (in kilowatts) during
...
outputFile <- paste(outputDirectory, "/plot01_", titleText, ".png", sep = "")
...
hist(inputData$Global_active_power, main=titleText, 
